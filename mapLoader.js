...
export const MAPS = {
    ...
    inferno: {
        name: 'de_inferno',
        path: '/maps/inferno.glb?v=1',
        sizeMB: 70,
        scale: VRF_SCALE,
        zUp: false,
        collisionPath: '/maps/inferno-collision.glb?v=1',
        softGroundPath: '/maps/inferno-softground.json?v=1',
        // priority-0 info_player_* from de_inferno default_ents.
        // App frame: x = game Y, z = game X; yaw = game yaw.
        spawns: {
            T: [
